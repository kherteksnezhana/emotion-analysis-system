...
Платформа для анализа эмоционального состояния сотрудников на основе ежедневных текстовых отчётов. Использует RuBERT для классификации эмоций и расчёта индекса выгорания.
